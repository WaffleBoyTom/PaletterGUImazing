#include "cool_widget_debug.h"

void
coolDebugGeometry(const QWidget *w, const std::string &name)
{
    if (!name.empty())
        qDebug() << name;
...
void
coolDebugSizing(const QWidget *w, const std::string &name)
{
    if (!name.empty())
        qDebug() << name;
...
void
coolDebugLayout(const QWidget *w, const std::string &name)
{
    if (!name.empty())
        qDebug() << name;
